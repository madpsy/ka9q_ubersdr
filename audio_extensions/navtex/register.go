...
// Factory creates a new NAVTEX extension instance
func Factory(audioParams AudioExtensionParams, extensionParams map[string]interface{}) (AudioExtension, error) {
	if audioParams.Channels != 1 {
		return nil, fmt.Errorf("NAVTEX requires mono audio (got %d channels)", audioParams.Channels)
	}
	if audioParams.BitsPerSample != 16 {
		return nil, fmt.Errorf("NAVTEX requires 16-bit audio (got %d bits)", audioParams.BitsPerSample)
	}

	return NewNAVTEXExtension(audioParams.SampleRate, extensionParams)
}
	...
	return map[string]interface{}{
		...
		"parameters": map[string]interface{}{
			...
			"framing": map[string]interface{}{
				"type":        "string",
				"description": "Framing (4/7 for NAVTEX, 7/3 for DSC)",
				"default":     "4/7",
			},
			"encoding": map[string]interface{}{
				"type":        "string",
				"description": "Character encoding (CCIR476 for NAVTEX)",
				"default":     "CCIR476",
			},
		},

...
echo ""
echo "==> index.html changes needed:"
echo "    <head>: replace 8 script tags (suncalc→rmnoise) with:"
echo "      <script src=\"dist/head-bundle.min.js\"></script>"
echo ""
echo "    <body>: replace 22 script tags (bands_state→pages-menu) with:"
echo "      <script src=\"dist/body-bundle.min.js\"></script>"
echo ""
echo "    Replace ES module tags with plain scripts:"
echo "      <script src=\"dist/local-bookmarks.bundle.min.js\"></script>"
echo "      <script src=\"dist/app.bundle.min.js\"></script>"

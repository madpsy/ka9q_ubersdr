...
(function() {
    ...
    // Export the NREngine constructor so multi-instance consumers (e.g. multi_monitor.js)
    // can create independent per-radio engines with `new window.NREngine()`.
    window.NREngine = NREngine;

...
class InstanceManager:
    ...
    async def fetch_server_info(self, instance: SpectrumInstance) -> None:
    ...
    async def check_connection_allowed(self, instance: SpectrumInstance) -> Tuple[bool, str]:
        ...
        try:
            ...
            print(f"Connection check failed for {instance.name}: {e}")
            # Continue on error (like the web UI does)
            return True, ""
    ...
    def connect_instance(self, instance: SpectrumInstance, spectrum_display) -> bool:
        ...
        try:
            ...
            try:
                ...
                loop.run_until_complete(self.fetch_server_info(instance))

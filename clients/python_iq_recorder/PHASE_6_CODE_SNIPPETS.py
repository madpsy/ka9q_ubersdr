#!/usr/bin/env python3
"""
Phase 6: Multi-Channel Tabbed UI - Code Snippets
Complete implementation code for the tabbed multi-channel interface

INTEGRATION INSTRUCTIONS:
1. Add these methods to the IQSpectrumDisplay class in iq_spectrum_display.py
2. Replace the existing create_audio_controls() method (lines 204-348)
3. Add configuration loading to __init__() after audio_mixer initialization
4. Update on_mouse_motion() to update active channel frequency
"""

# ============================================================================
# MAIN UI CREATION METHOD (REPLACES EXISTING create_audio_controls)
# ============================================================================
...
def on_channel_active_changed(self):
    """Handle active checkbox change (no-op, always checked for active channel)"""
    pass
...
# ============================================================================
# LEGACY SINGLE-CHANNEL UI (FALLBACK)
# ============================================================================

def _create_legacy_audio_controls(self):
    """Create legacy single-channel audio controls (fallback)"""
    # Keep existing single-channel implementation for backward compatibility
    # This is the original create_audio_controls code (lines 204-348)
    # Copy the existing implementation here
    pass  # Implementation omitted for brevity - use existing code
...
"""
TO INTEGRATE INTO iq_spectrum_display.py:

1. Add to __init__() method after audio_mixer initialization (around line 180):
...
2. Update on_mouse_motion() method to update active channel frequency:
   
   # After calculating freq_hz from mouse position
   if self.audio_mixer:
       active_channel = self.get_active_channel()
...
3. Replace create_audio_controls() method (lines 204-348) with the new implementation above

4. Add all the new methods to the class

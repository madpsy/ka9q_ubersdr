...
/* web/extensions/TDoA/TDoA.min.js (web/extensions/TDoA/TDoA.js = Fri Nov 28 15:28:50 2025) */
...
tdoa_set_icon('sample',field_idx,'fa-refresh fa-spin',20,'lightGrey');tdoa_rerun_clear();var s=(dbgUs&&val=='kiwisdr.jks.com:8073')?'www:8073':val;var hp=val.split(':');if(hp.length==1)hp[1]='8073';f.host={h:hp[0],p:hp[1]};kiwi_ajax('http://'+s+'/status','tdoa_host_click_status_cb',-field_idx,5000);tdoa_rebuild_hosts();}

...
/* web/extensions/colormap/colormap.min.js (web/extensions/colormap/colormap.js = Sat Aug  9 21:42:37 2025) */
...
c.clearRect(0,0,cmap.w,cmap.h);xy=colormap_mouseXY('id-cmap-overlay-canvas',evt);c.strokeStyle='white';c.beginPath();c.moveTo(cmap.xy0.x,cmap.xy0.y);c.lineTo(xy.x,xy.y);c.stroke();cmap.xy1=xy;return;default:return;}}
...
w3_div('w3-text-white','<br>Select a custom colormap from the <x1>colormap</x1> menu (e.g. "cust1") '+'then draw by mousing-down in large box. Try the other controls to see their effect. '+'Colormap changes are shown immediately in the waterfall.');confirmation_show_content(s,610,150);}
return true;}

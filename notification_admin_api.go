...
func handleNotificationsSchema(w http.ResponseWriter, r *http.Request) {
	...
	eventTypes := []eventType{
		...
		},
		{
			...
			FilterFields: []filterField{
				{Name: "components", Type: "[]string", Description: "Subsystem names to watch. Empty = all components.", ValidValues: []string{"noise_floor", "space_weather", "decoder", "cw_skimmer", "mqtt", "rotator", "ant_switch", "frequency_reference", "instance_reporter", "sdr_frontend", "if_power", "gpsdo", "system_load", "cpu_temperature", "dsp", "software_version"}, Example: `["decoder","cw_skimmer"]`},
	...
	resp := map[string]interface{}{
		...
		"monitor_components": []string{
			...
			"sdr_frontend", "if_power", "gpsdo", "system_load", "cpu_temperature", "dsp",
			"software_version",
		},
	}

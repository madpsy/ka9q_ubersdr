/**
 * QRSS Grabber — down-converting capture AudioWorklet (v2)
 *
 * A copy of extensions/qrss/qrss-worklet.js, sitting beside
 * pcm-recorder-worklet.js because that is where the v2 client loads its
 * worklets from: v2 must not depend on the v1 extension tree, which is being
 * retired. The processor name differs from v1's so the two can be registered in
 * one context without collision.
 *
...
registerProcessor('qrss-ddc-processor-v2', QrssDDCProcessor);

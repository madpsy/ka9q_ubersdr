...
class SpectrumDisplay {
    ...
    getColorScheme(name) {
        const schemes = {
            ...
            // Sonar / Night Vision palettes — ported from VibeSDR colormaps.ts
            'sonar-green': [
                [0,0,0],[0,8,0],[0,26,0],[0,51,0],[0,80,0],[0,120,0],
                [0,170,0],[0,204,0],[0,255,0],[128,255,128],[204,255,204],[239,255,255]
            ],
            'sonar-orange': [
                [0,0,0],[13,4,0],[26,8,0],[46,16,0],[74,26,0],[110,40,0],
                [158,60,0],[200,80,0],[232,104,0],[255,140,32],[255,184,96],[255,240,204]
            ],
            'night-vision': [
                [0,0,0],[12,0,0],[26,0,0],[46,0,0],[74,0,0],[112,0,0],
                [160,0,0],[204,0,0],[238,16,16],[255,64,64],[255,128,128],[255,204,204]
            ]
        };

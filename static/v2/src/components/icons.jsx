...
export const Icon = {
    ...
    // with the shackle swung clear, so the pair reads as one switch rather than
    // as two icons that happen to both be locks.
    Lock: (p) => <Svg {...p}><rect x="4.5" y="10.5" width="15" height="10.5" rx="2" /><path d="M8 10.5V7.5a4 4 0 0 1 8 0v3" /></Svg>,
    Unlock: (p) => <Svg {...p}><rect x="4.5" y="10.5" width="15" height="10.5" rx="2" /><path d="M8 10.5V7.5a4 4 0 0 1 7.7-1.1" /></Svg>,

// Band conditions: the buckets, and what an absence means.
//
// Three panels colour bands from this — the Quick bands keys, the Multipad's
// band row and the Bands panel — so a disagreement here is parts of one screen
// saying different things about the same band. The thresholds are v1's and are
// pinned so they cannot drift apart. The reading they are applied to, and the
// single poll behind it, are lib/bandNoise.js's — see bandnoise.test.js.

const assert = require('assert');
const {
    bandTip, bandTone, classify,

...
esbuild ../src/lib/dockSize.js --bundle --format=cjs --platform=node \
    --outfile=.build/docksize.cjs --log-level=warning
...
esbuild dockpin.entry.js --bundle --format=cjs --platform=node \
    --outfile=.build/dockpin.cjs --log-level=warning
...
esbuild floatdrag.entry.js --bundle --format=cjs --platform=node \
    --outfile=.build/floatdrag.cjs --log-level=warning
